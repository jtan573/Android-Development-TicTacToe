...
object SupabaseService {
    ...
    /*
    You can call this function to release your turn.
    The other player knows then, that it is his or her turn.
    */
    ...
    /*
    You can call this function if you finished the game,
    for example the players action finished the game as DRAW, WIN, or LOSE.
    */
    ...
    /* You can call this function to send the player ready message to the other player to let them know you are ready to start. */
    ...
    suspend fun sendMessageToGame(event: BroadcastEvent, message: JsonObject) {
        _game?.broadcast(
            event = event.name,
            message = message
        )
